...
function game() {
  ...
  console.log("The X coordinate of my nose on the video which is inside the div which is the canvas and holds the console background is " + noseX + ", and the Y coordinate of my nose on the video which is inside the div which is the canvas and holds the console background is " + noseY);
